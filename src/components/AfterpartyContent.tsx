...
interface AfterpartyContentProps {
  isOpen: boolean;
}

const AfterpartyContent = ({ isOpen }: AfterpartyContentProps) => {
  ...
  return (
    <div className="invite-stage afterparty-theme timeline-root min-h-screen bg-background">
      ...
      <section className="timeline-section min-h-[100svh] py-16 px-6 md:py-24 md:px-12 max-w-2xl mx-auto text-center flex items-center justify-center">
        ...
        <div className="w-full space-y-10 md:space-y-14">
          <ScrollReveal isEnabled={isOpen}>
            <div className="space-y-4">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-light text-foreground leading-tight">
                ...
                {renderAnimatedWords("25’thAfterparty", 0.55, {
                  firstLetterMode: "all",
                  directionMode: "right",
                })}
              </h1>
          ...
          <ScrollReveal isEnabled={isOpen} delay={130}>
            <p className="dropcap-line text-muted-foreground font-sans text-sm sm:text-base leading-relaxed">
              {renderAnimatedWords(
                "As the evening continues, i would love to celebrate and close this special day with you.",
                0.01,
                {
          ...
          <ScrollReveal isEnabled={isOpen} delay={200}>
            <button
              type="button"
              onClick={() => scrollTo(introRef.current)}
          ...
          <ScrollReveal isEnabled={isOpen}>
            <div className="space-y-4">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight">
                {renderAnimatedWords("Sunday 13.09.26.", 0.02, {
                  firstLetterMode: "none",
                  directionMode: "left",
                  wordStep: 0.1,
                })}
        ...
        <div className="w-full space-y-10 md:space-y-14">
          <ScrollReveal isEnabled={isOpen}>
            <div className="space-y-4">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight">
                {renderAnimatedWords("Time & Address", 0.03, {
                  firstLetterMode: "cadence",
                  firstLetterEvery: 2,
                  directionMode: "reverseAlternate",
                })}
          ...
          <ScrollReveal isEnabled={isOpen} delay={130}>
            <div className="space-y-5 text-muted-foreground font-sans text-sm sm:text-base leading-relaxed">
              <p className="dropcap-line">
                Time: you are kindly requested to arrive at 20:30.
                <br />
                Please note that arrival before this time is not possible.
              </p>
              <p className="dropcap-line">
...
export default AfterpartyContent;
